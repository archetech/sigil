...
34 requirements · 24 design points · 4 tagged code files · 3 tagged test files.
...
| R3 | AC-3, AC-9, DC-3 | D-PM-3, D-AAC-11, D-AAC-2, D-AAC-5, D-DC-3 | src/archon/issuer.ts, src/archon/signatures.ts, src/verify.ts | test/issuer.test.ts, test/archon.test.ts, test/verify.test.ts | D:✓ C:✓ T:✓ |
...
| R9 | AC-13, AC-7, AC-8 | D-AAC-11, D-AAC-4, D-AS-1, D-AAC-10 | src/verify.ts, src/archon/resolver.ts | test/issuer.test.ts, test/verify.test.ts, test/archon.test.ts | D:✓ C:✓ T:✓ |
